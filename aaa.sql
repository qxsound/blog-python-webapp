...
-- insert into users (`id`, `email`, `password`, `admin`, `name`, `image`, `created_at`) values ('9010018336417540987fff4508f43fbaed718e263442526000', 'James@example.com', '49ba59abbe56e057', 1, 'Administrator', 'about:{}', 1402909113.628);
